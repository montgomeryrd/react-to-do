                ...
                <div className="dashboard-content-view">
                    ...
                    <div className="navigation-container">
                        <Router>
                            ...
                            (<TasksPage {...props} checkState={this.checkState} value={this.state.value} tasks={this.state.tasks} handleChange={this.handleChange} handleSubmit={this.handleSubmit} removeItem={this.removeItem} archiveItem={this.archiveItem}/>)} />
                            <Route path="/goals" render={props =>
                            (<GoalsPage {...props} checkState={this.checkState} value={this.state.value} goals={this.state.goals} handleChange={this.handleChange} handleSubmit={this.handleSubmit} removeItem={this.removeItem} archiveItem={this.archiveItem}/>)} />
                            <Route path="/archive" render={props =>
                            (<Archive {...props} checkState={this.checkState} archivedTasks={this.state.archivedTasks} archivedGoals={this.state.archivedGoals} />)} />
                        </Router>
                    </div>
                </div>
            </div>
